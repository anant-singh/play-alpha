(function () {
    ...
    $(document).ready(function () {
        ...
        $(".pie-chart1").easyPieChart({size: 220, lineWidth: 12, lineCap: "square", barColor: "#81e970", animate: 800, scaleColor: false});
        $(".pie-chart2").easyPieChart({size: 220, lineWidth: 12, lineCap: "square", barColor: "#f46f50", animate: 800, scaleColor: false});
        $(".pie-chart3").easyPieChart({size: 220, lineWidth: 12, lineCap: "square", barColor: "#fab43b", animate: 800, scaleColor: false});
        ...
        $("#dataTable1").dataTable({"sPaginationType": "full_numbers", aoColumnDefs: [
        ...
        calendar = $("#calendar").fullCalendar({header: {left: "prev,next today", center: "title", right: "month,agendaWeek,agendaDay"}, selectable: true, selectHelper: true, select: function (start, end, allDay) {
            ...
            {title: "Lunch", start: new Date(y, m, d, 14, 0), end: new Date(y, m, d, 16, 0), allDay: false},
